...
➂ pū。通“扑”。击，打。《诗经·<ac-font-source text="豳" :explain="{pinyin:'bīn',explain:[{explain:'古国名，周代先祖公刘在此立国，在今陕西旬邑西南一带',source:'古汉语字典'}],more:'../B/bin#豳'}" />风·七月》：“八月～枣，十月获稻。”
...
➂ 拍，打。李斯《谏逐客书》：“弹筝～<ac-font-source text="髀" :explain="{pinyin:'bì',explain:[{explain:'大腿。',source:'古汉语字典'}],more:'../B/bi#髀'}" />。”（髀：大腿。搏髀：指在腿上打节拍。）
...
➁ 倒毙，死亡。《国语·鲁语上》：“（夏）桀奔南巢，（商）纣～于京。”（南巢：地名。京：京都。）【辨】偃、僵、仆、跌、毙、踣。见“[偃](../Y/yan#偃)”字。
