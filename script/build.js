...
const buildDir = path.join(__dirname, '../ancient-chinese-website');
const zipFileName = 'ancient-chinese-website.zip';
...
const safeRemoveDir = (dirPath) => {
  ...
  // 仅允许删除预期的构建目录
  if (path.basename(resolved) !== 'ancient-chinese-website') {
